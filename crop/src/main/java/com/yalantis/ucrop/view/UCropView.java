...
import com.huanhang.ucrop.HuanHangCropView;
...
public class UCropView extends FrameLayout {
    ...
    private final HuanHangCropView mViewOverlay;
    ...
    public UCropView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        LayoutInflater.from(context).inflate(getCropLayout(), this, true);
        mGestureCropImageView = (GestureCropImageView) findViewById(R.id.image_view_crop);
        mViewOverlay = (HuanHangCropView) findViewById(R.id.view_overlay);
    ...
    @NonNull
    public HuanHangCropView getOverlayView() {
        return mViewOverlay;
    }
